    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-book"></i>Help Center</li>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                    <form class="form-horizontal" method="POST" id="submitForm" action="#">
                       ...
                       <div class="col-sm-12">
                          <ul class="todo-list">
                            <li>
                              ...
                              <div class="tools">
                              <a href="#collapse1" data-toggle="collapse" aria-expanded="false" aria-controls="collapse1"> <i class="fa fa-edit"></i></a>
                            ...
                            <li>
                              ...
                              <input type="checkbox" value="" name=""/>
                              <span class="text">Question 6</span>
                  ...
                  <div class="form-group">
                        <div class="col-sm-12">
                         <button class="btn btn-default"><i class="fa fa-plus"></i> Add item</button>
                         </div>
                  </div>
