...
<html>
  ...
  <link rel="stylesheet" href="dist/css/formbuilder.css" />
  ...
  <script src="dist/js/formbuilder.js"></script>
  ...
  <script>
    ...
    <script>
     ...
     function urlChange() {
        ...
        if (url.length > 0 ) {
            $("#urlDiv").html("<iframe src="+ url +"><p>Your browser does not support iframes.</p></iframe>");
            $("#urlDiv").show();
            $("#urlBr").show();
        } else {
            $("#urlEmbed").remove();
